...
public class MiniGUI {
    ...
    public MiniGUI() {
        ...
        // Part 2.
        final JTextField result = new JTextField("Press the button below to generate a new number.");
        ...
        write.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                // Part 3.
                final int newResult = randomGenerator.nextInt();
                System.out.println(newResult);
                result.setText(Integer.toString(newResult));
            }
        });
    }
